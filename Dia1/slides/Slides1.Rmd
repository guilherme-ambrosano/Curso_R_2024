...
- **2.** Dicotomizar todas as colunas do data frame `attitude` pela mediana, como feito no exercício **1.**, com um único comando (Dica: família apply)
- **3.** Obter as médias de `learning` para valores abaixo e acima da mediana de `critical`
